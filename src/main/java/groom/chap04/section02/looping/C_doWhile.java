package groom.chap04.section02.looping;
...
public class C_doWhile {
    ...
    public void testSimpleDoWhileStatement(){
        ...
        /* 목표. do-while문 단독 사용에 대한 흐름을 이해하고 적용할 수 있다. */
        /* [do-while문 표현식]
         *  초기식;
         *  do {
    ...
    public void testDoWhileExample() {
        ...
        do {
            ...
            /* equals() : 문자열은 == 비교가 불가능하다. 문자열이 같은지를 비교하는 기능을 제공하는데 뒤에서 다시 다루게 된다. */
