package groom.chap05.section01.array;
...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         *  new 연산자는 heap 영억에 공간을 할당하고 발생한 주소값을 반환하는 연산자이다.
         *  발생한 주소를 래퍼런스 변수(참조형 변수)에 저장하고 이것을 참조하여 사용하기 때문에 참조자료형(reference type)이라고 한다.
         */

        /* 선언은 stak에 배열의 주소를 보관할 수 있는 공간을 반드는 것이다. */
//        iarr = new int[];                               // 크기를 지정해 주지 않아서 에러 발생
         ...
         *  stack에 저장된 heap에 할당된 배열을 찾아갈 수 있다.
         */
        System.out.println("iarr : " + iarr2);          //i6진수 주소값 출력
        System.out.println("iarr : " + carr2);          //i6진수 주소값 출력
        ...
        /* 스캐너를 통해 입력받는 정수로 배열 길이를 지정하여 배열을 할당할 수 있다. */
         ...
         *  아무것도 참조하지 않고 null이라는 특수한 값을 참조하고 있는 경우 참조연산자를 이용하게 될 때 발생하는 에러이다.
         */
//        System.out.println("삭제 후 darr의 길이 : " + darr.length);               //NullPointException 발생
